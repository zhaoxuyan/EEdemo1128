package me.yokeyword.sample.demo.ui.fragment.second.child;
 ...
 */
public class FirstPagerDetailFragment extends BaseBackFragment {
    ...
    public static FirstPagerDetailFragment newInstance(Article article) {

        Bundle args = new Bundle();
        args.putParcelable(ARG_ITEM, article);
        FirstPagerDetailFragment fragment = new FirstPagerDetailFragment();
