...
import me.yokeyword.sample.demo.base.BaseMainFragment;
import me.yokeyword.sample.demo.event.TabSelectedEvent;
import me.yokeyword.sample.demo.ui.fragment.first.ZhihuFirstFragment;
import me.yokeyword.sample.demo.ui.fragment.first.child.FirstHomeFragment;
import me.yokeyword.sample.demo.ui.fragment.fourth.ZhihuFourthFragment;
import me.yokeyword.sample.demo.ui.fragment.fourth.child.MeFragment;
import me.yokeyword.sample.demo.ui.fragment.second.ZhihuSecondFragment;
import me.yokeyword.sample.demo.ui.fragment.second.child.ViewPagerFragment;
import me.yokeyword.sample.demo.ui.fragment.third.ZhihuThirdFragment;
import me.yokeyword.sample.demo.ui.fragment.third.child.ShopFragment;
import me.yokeyword.sample.demo.ui.view.BottomBar;
import me.yokeyword.sample.demo.ui.view.BottomBarTab;
...
public class MainActivity extends SupportActivity implements BaseMainFragment.OnBackToFirstListener {
    ...
    private void initView() {
        ...
        mBottomBar.addItem(new BottomBarTab(this, R.drawable.ic_home_white_24dp,"首页"))
                .addItem(new BottomBarTab(this, R.drawable.ic_discover_white_24dp,"健康推送"))
                .addItem(new BottomBarTab(this, R.drawable.ic_message_white_24dp,"一键救助"))
