 ...
 */
public class SecondPagerFragmentAdapter extends RecyclerView.Adapter<SecondPagerFragmentAdapter.VH> {
    ...
    public SecondPagerFragmentAdapter(Context context) {
        mInflater = LayoutInflater.from(context);
    }

    @Override
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_zhihu_home_second, parent, false);
