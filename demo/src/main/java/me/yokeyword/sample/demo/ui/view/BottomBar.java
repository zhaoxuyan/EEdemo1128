package me.yokeyword.sample.demo.ui.view;
...
//        addView(shadowView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    public me.yokeyword.sample.demo.ui.view.BottomBar addItem(final me.yokeyword.sample.demo.ui.view.BottomBarTab tab) {
        tab.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener == null) return;
    ...
    public void setOnTabSelectedListener(me.yokeyword.sample.demo.ui.view.BottomBar.OnTabSelectedListener onTabSelectedListener) {
        mListener = onTabSelectedListener;
    }
     ...
     * 获取 Tab
     */
    public me.yokeyword.sample.demo.ui.view.BottomBarTab getItem(int index) {
    ...
    protected Parcelable onSaveInstanceState() {
        Parcelable superState = super.onSaveInstanceState();
        return new me.yokeyword.sample.demo.ui.view.BottomBar.SavedState(superState, mCurrentPosition);
    }

    @Override
    protected void onRestoreInstanceState(Parcelable state) {
        me.yokeyword.sample.demo.ui.view.BottomBar.SavedState ss = (me.yokeyword.sample.demo.ui.view.BottomBar.SavedState) state;
        super.onRestoreInstanceState(ss.getSuperState());
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Creator<BottomBar.SavedState> CREATOR = new Creator<BottomBar.SavedState>() {
            public BottomBar.SavedState createFromParcel(Parcel in) {
                return new me.yokeyword.sample.demo.ui.view.BottomBar.SavedState(in);
            }
